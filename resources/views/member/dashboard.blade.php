                        ...
                        <div class="col-12">
                            <h4 class="total-num">
                                <span class="counter">
                                    ...
                                    {{ number_format($monthly_due['amount']) }}
                                </span>
                                ৳
                            </h4>
                        ...
                        <div class="col-12">
                            <h4 class="total-num">
                                <span class="counter">
                                    ...
                                    {{ number_format($onetime_due['amount']) }}
                                </span>
                                ৳
                            </h4>
                ...
                <div class="ecommerce-widget card-body">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="total-num">
                                <span class="counter">
                                    {{ number_format($monthly_due['amount'] + $onetime_due['amount'] - $total_paid) }}
                                </span>
                                ৳
                            </h4>
                    ...
                    <div class="flot-chart-container">
                        ...
                        <div class="mt-1">
                            <span class="bn">মাসিক:</span> {{ number_format($monthly_due['amount'] - $monthly_paid) }}
                        </div>
                        <div>
                            <span class="bn">একাকালিন:</span>
                            {{ number_format($onetime_due['amount'] - $onetime_paid) }}
                        </div>
